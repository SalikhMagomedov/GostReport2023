\usepackage{amssymb} % akm, smm
\usepackage{colortbl} % akm
\usepackage{amsmath} % bab
\usepackage{makecell} % bab
\usepackage{graphicx} % bab, rmk
\graphicspath{{./pictures/}}
\usepackage{subcaption} % bab, rmk
\usepackage{hyperref} % bab, rmk
\usepackage{cite} % bab, rmk
\usepackage{amsthm}

% Обеспечивает перенос текста для предложений с тире,
% но требует замены "-" на "\-/"
